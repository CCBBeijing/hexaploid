...
for(j in 1){
  ...
  for(i in 1:20){
    ...
    p222=c(0.1 ,0.2 ,0.3 ,0.25,0.21,0.15)[j]
    p221=c(0.05,0.21,0.14,0.2 ,0.23,0.15)[j]
    p220=c(0.2 ,0.06,0.1 ,0.13,0.06,0.12)[j]
    p210=c(0.25,0.1 ,0.12,0.2 ,0.12,0.11)[j]
    p200=c(0.13,0.18,0.11,0.05,0.08,0.17)[j]
    p100=c(0.1 ,0.12,0.08,0.02,0.13,0.1)[j]
    p000=c(0.17,0.13,0.15,0.15,0.17,0.2)[j]
  ...
  p3 <- f3[20];p2 <- f2[20];p1 <- f1[20];p0 <- f0[20]
