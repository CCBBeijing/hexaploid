...
#find that double reduction has little impact on the attainment of aHWE in autohexaploids, but affects the values of equilibrium genotype frequencies (Fig. 1B), suggesting that double reduction is a driver of hexaploid evolution.
